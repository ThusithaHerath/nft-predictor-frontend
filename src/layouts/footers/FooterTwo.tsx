            ...
            <div className="row justify-content-between">
               ...
               <div className="col-xl-auto col-lg-6 order-xl-2">
                  <div className="footer-widget widget-contact">
                     ...
                     <div className="contact-info-link">Call Us: <Link to="tel:8002758777">800.275.8777</Link></div>
                     <div className="contact-info-link"><Link to="mailto:NFT Predictor@company.com">NFT Predictor@company.com</Link></div>
