            ...
            <div className="row justify-content-between align-items-center">
               ...
               <div className="col-xl-6">
                  <ul className="feature-category-list mb-xl-0 mb-60">
                     <li>
                        <Link to="/blog-details">Smart contracts</Link>
                     </li>
                     <li>
                        <Link to="/blog-details">Paying employees</Link>
                     </li>
                     <li>
                        <Link to="/blog-details">Cloud storage</Link>
                     </li>
                     <li>
                        <Link to="/blog-details">Electronic voting</Link>
                     </li>
                  </ul>
               </div>
            </div>
